...
Partial Class Library
    ...
    Private Sub InitializeComponent()
        ...
        TipLibraryEX = New Skye.UI.ToolTipEX(components)
        ...
        TipLibraryEX.SetImage(BtnSearchFolders, Nothing)
        ...
        TipLibraryEX.SetText(BtnSearchFolders, Nothing)
        ...
        TipLibraryEX.SetImage(BtnOK, Nothing)
        BtnOK.Location = New Point(874, 444)
        BtnOK.Name = "BtnOK"
        BtnOK.Size = New Size(64, 64)
        BtnOK.TabIndex = 3
        BtnOK.TabStop = False
        TipLibraryEX.SetText(BtnOK, Nothing)
        ...
        TipLibraryEX.SetImage(TxbxLibrarySearch, Nothing)
        ...
        TipLibraryEX.SetText(TxbxLibrarySearch, Nothing)
        ...
        TipLibraryEX.SetImage(LBXLibrarySearch, Nothing)
        ...
        TipLibraryEX.SetText(PicBoxAlbumArt, Nothing)
        ...
        TipLibraryEX.SetImage(RadBtnGroupByGenre, Nothing)
        ...
        TipLibraryEX.SetText(RadBtnGroupByGenre, Nothing)
        ...
        TipLibraryEX.SetImage(GrpBoxGroupBy, Nothing)
        ...
        TipLibraryEX.SetText(GrpBoxGroupBy, Nothing)
        ' 
        ' RadBtnGroupByType
        ' 
        ...
        TipLibraryEX.SetImage(RadBtnGroupByType, Nothing)
        ...
        TipLibraryEX.SetText(RadBtnGroupByType, Nothing)
        ...
        TipLibraryEX.SetImage(RadBtnGroupByYear, Nothing)
        ...
        TipLibraryEX.SetText(RadBtnGroupByYear, Nothing)
        ...
        TipLibraryEX.SetImage(RadBtnGroupByArtist, Nothing)
        ...
        TipLibraryEX.SetText(RadBtnGroupByArtist, Nothing)
        ...
        TipLibraryEX.SetImage(RadBtnGroupByAlbum, Nothing)
        ...
        TipLibraryEX.SetText(RadBtnGroupByAlbum, Nothing)
        ...
        TipLibraryEX.SetImage(RadBtnGroupByNone, Nothing)
        ...
        TipLibraryEX.SetText(RadBtnGroupByNone, Nothing)
        ...
        TipLibraryEX.SetImage(LblExtTitle, Nothing)
        LblExtTitle.Location = New Point(119, 420)
        LblExtTitle.Name = "LblExtTitle"
        LblExtTitle.Size = New Size(464, 20)
        LblExtTitle.TabIndex = 19
        LblExtTitle.Text = "Title"
        TipLibraryEX.SetText(LblExtTitle, Nothing)
        ...
        TipLibraryEX.SetImage(LblExtFileInfo, Nothing)
        LblExtFileInfo.Location = New Point(119, 441)
        LblExtFileInfo.Name = "LblExtFileInfo"
        LblExtFileInfo.Size = New Size(464, 20)
        LblExtFileInfo.TabIndex = 20
        LblExtFileInfo.Text = "File Info"
        TipLibraryEX.SetText(LblExtFileInfo, Nothing)
        ...
        TipLibraryEX.SetImage(LblExtProperties, Nothing)
        LblExtProperties.Location = New Point(119, 461)
        LblExtProperties.Name = "LblExtProperties"
        LblExtProperties.Size = New Size(464, 20)
        LblExtProperties.TabIndex = 21
        LblExtProperties.Text = "Properties"
        TipLibraryEX.SetText(LblExtProperties, Nothing)
        ...
        TipLibraryEX.SetImage(LblExtType, Nothing)
        LblExtType.Location = New Point(119, 482)
        LblExtType.Name = "LblExtType"
        LblExtType.Size = New Size(464, 20)
        LblExtType.TabIndex = 22
        LblExtType.Text = "Type"
        TipLibraryEX.SetText(LblExtType, "TYPE")
        ...
        TipLibraryEX.SetImage(LblLibraryCounts, Nothing)
        ...
        TipLibraryEX.SetText(LblLibraryCounts, Nothing)
        ...
        TipLibraryEX.SetImage(LVLibrary, Nothing)
        ...
        TipLibraryEX.SetText(LVLibrary, Nothing)
        ...
        TipLibraryEX.SetImage(LblHistory, Nothing)
        LblHistory.Location = New Point(119, 400)
        LblHistory.Name = "LblHistory"
        LblHistory.Size = New Size(464, 20)
        LblHistory.TabIndex = 25
        LblHistory.Text = "History"
        TipLibraryEX.SetText(LblHistory, "HISTORY")
        LblHistory.TextAlign = ContentAlignment.MiddleLeft
        ' 
        ' TipLibraryEX
        ' 
        TipLibraryEX.FadeInRate = 25
        TipLibraryEX.FadeOutRate = 25
        TipLibraryEX.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        TipLibraryEX.HideDelay = 250
        TipLibraryEX.ShadowAlpha = 0
        TipLibraryEX.ShadowThickness = 0
        TipLibraryEX.ShowDelay = 250
        ' 
        ' Library
        ' 
        ...
        TipLibraryEX.SetImage(Me, Nothing)
        KeyPreview = True
        MinimumSize = New Size(1000, 561)
        Name = "Library"
        StartPosition = FormStartPosition.CenterScreen
        TipLibraryEX.SetText(Me, Nothing)
        Text = "Library"
    ...
    Friend WithEvents TipLibraryEX As Skye.UI.ToolTipEX
End Class
