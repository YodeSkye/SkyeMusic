...
Public Class Options
    ...
    Private Sub Options_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        CoBoxTheme.Items.Add("Emerald Accent")
        CoBoxTheme.Items.Add("Violet Accent")
        CoBoxTheme.Items.Add("Amber Accent")
        CoBoxTheme.Items.Add("Teal Accent")
        CoBoxTheme.Items.Add("High Contrast")
        CoBoxTheme.Items.Add(Themes.Light.ToString)
        CoBoxTheme.Items.Add(Themes.Dark.ToString)
        CoBoxTheme.Items.Add("Dark Pink")
        CoBoxTheme.Items.Add(Themes.Blossom.ToString)
        CoBoxTheme.Items.Add("Crimson Ember")
        CoBoxTheme.Items.Add("Midnight Blue")
        CoBoxTheme.Items.Add("Forest Green")
        CoBoxTheme.Items.Add("Solar Gold")
        CoBoxTheme.Items.Add(Themes.Amethyst.ToString)
        CoBoxTheme.Items.Add(Themes.Glacier.ToString)
